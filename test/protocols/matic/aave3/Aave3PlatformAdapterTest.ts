  ...
  const TEST_SETUPS: Record<number, ITestSetup> = {
    [POLYGON_NETWORK_ID]: {
      ...
      pairsToBorrowNormalMode: [
        ...
        {collateralAsset: MaticAddresses.DAI, borrowAsset: MaticAddresses.USDC, amount: "1000", collateralAssetName: "DAI", borrowAssetName: "USDC"},
        ...
        {collateralAsset: MaticAddresses.USDC, borrowAsset: MaticAddresses.USDT, amount: "1000", collateralAssetName: "USDC", borrowAssetName: "USDT"},
      ],
      pairsToBorrowIsolationMode: [
        {collateralAsset: MaticAddresses.EURS, borrowAsset: MaticAddresses.USDT, amount: "1000", collateralAssetName: "EURS", borrowAssetName: "USDT"}
      ],
      pairsToBorrowEMode: [
        {collateralAsset: MaticAddresses.DAI, borrowAsset: MaticAddresses.USDC, amount: "1000", collateralAssetName: "DAI", borrowAssetName: "USDC"},
      ],
      ...
      describe("getConversionPlan", () => {
        ...
        describe("Bad paths", () => {
          async function tryGetConversionPlan(
            badPathsParams: IGetConversionPlanBadPaths,
            collateralAsset: string = testSetup.pair.collateralAssetName,
