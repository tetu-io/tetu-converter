...
//region Global vars for all tests
  ...
  let cUsdc: IKeomToken;
  let cWeth: IKeomToken;
...
//region before, after
  before(async function () {
    ...
    cUsdc = IKeomToken__factory.connect(ZkevmAddresses.oUSDC, deployer);
    cWeth = IKeomToken__factory.connect(ZkevmAddresses.oUSDT, deployer);
  });
