...
import {CompoundAprLibFacade, IERC20Metadata__factory, IZerovixComptroller, IMToken} from "../../../../typechain";
import {BigNumber, BigNumberish} from "ethers";
import {SignerWithAddress} from "@nomiclabs/hardhat-ethers/signers";
import {MocksHelper} from "../../app/MocksHelper";
import {ZerovixUtilsZkevm} from "./ZerovixUtilsZkevm";

export class ZerovixPlatformActor implements IPlatformActor {
  ...
  async getBorrowRateAfterBorrow(borrowAsset: string, amountToBorrow: BigNumberish): Promise<BigNumber> {
    ...
    return this.libFacade.getBorrowRateAfterBorrow(ZerovixUtilsZkevm.getCToken(borrowAsset), amountToBorrow);
  }
