...
import {CompoundAprLibFacade, IERC20Metadata__factory, IMoonwellComptroller, IMToken} from "../../../../typechain";
import {BigNumber, BigNumberish} from "ethers";
import {SignerWithAddress} from "@nomiclabs/hardhat-ethers/signers";
import {MocksHelper} from "../../app/MocksHelper";
import {MoonwellUtils} from "./MoonwellUtils";

export class MoonwellPlatformActor implements IPlatformActor {
  ...
  async getBorrowRateAfterBorrow(borrowAsset: string, amountToBorrow: BigNumberish): Promise<BigNumber> {
    ...
    return this.libFacade.getBorrowRateAfterBorrow(MoonwellUtils.getCToken(borrowAsset), amountToBorrow);
  }
