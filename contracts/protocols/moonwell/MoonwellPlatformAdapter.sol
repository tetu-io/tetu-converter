...
//      activeAssets[MoonwellLib.getUnderlying(cTokens_[i])] = cTokens_[i];
//    }
//  }
...
//              pd.priceCollateral = MoonwellLib.getPrice(vars.priceOracle, vars.cTokenCollateral) * pd.rc10powDec;
//              pd.priceBorrow = MoonwellLib.getPrice(vars.priceOracle, vars.cTokenBorrow) * pd.rb10powDec;
...
//                ) = MoonwellLib.getRawCostAndIncomes(
//                  MoonwellLib.getCore(vars.cTokenCollateral, vars.cTokenBorrow),
...
//    return MoonwellLib.getEstimatedBorrowRate(
