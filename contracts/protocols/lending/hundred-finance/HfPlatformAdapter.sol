    ...
    if (cTokenCollateral != address(0)) {
      ...
      if (cTokenBorrow != address(0)) {
        ...
        if (plan.ltv18 != 0 && plan.liquidationThreshold18 != 0) {
          ...
          plan.brForPeriod18 = IHfCToken(cTokenBorrow).borrowRatePerBlock() * countBlocks_;
          if (borrowAmountFactor18_ != 0) {
            ...
            if (brAfterBorrow > plan.brForPeriod18) {
              plan.brForPeriod18 = brAfterBorrow * countBlocks_;
            }
          }
        }
      }
