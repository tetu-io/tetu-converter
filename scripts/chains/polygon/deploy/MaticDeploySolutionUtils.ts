...
export class MaticDeploySolutionUtils {
//region Main script
  static async runMain(
    ...
    const aave3AssetPairs = MaticDeploySolutionUtils.generateAssetPairs([
      MaticAddresses.USDC,
      MaticAddresses.USDT,
      MaticAddresses.DAI,
      // MaticAddresses.EURS,
    ...
    const aaveTwoPairs = MaticDeploySolutionUtils.generateAssetPairs([
      MaticAddresses.USDC,
      MaticAddresses.USDT,
      MaticAddresses.DAI,
      MaticAddresses.WMATIC,
    ...
    const dForcePairs = MaticDeploySolutionUtils.generateAssetPairs([
      MaticAddresses.USDC,
      MaticAddresses.USDT,
      MaticAddresses.DAI,
      MaticAddresses.WMATIC,
    ...
    const hundredFinancePairs = MaticDeploySolutionUtils.generateAssetPairs([
      MaticAddresses.USDC,
      MaticAddresses.USDT,
      MaticAddresses.DAI,
      MaticAddresses.WMATIC,
    ...
    const compound3Pairs = MaticDeploySolutionUtils.generateAssetPairs([
      MaticAddresses.USDC,
      MaticAddresses.WMATIC,
      MaticAddresses.WETH,
      MaticAddresses.WBTC,
    ...
    const deployCoreResults = await MaticDeploySolutionUtils.deployCoreContracts(
      signer,
      proxyUpdater,
      gelatoOpsReady,
    ...
    const platformAdapterAave3 = deployAave3
      ? await MaticDeploySolutionUtils.createPlatformAdapterAAVE3(signer,
    ...
    if (platformAdapterAave3) {
      ...
      await MaticDeploySolutionUtils.registerPlatformAdapter(
        borrowManager,
    ...
    const platformAdapterAaveTwo = deployAaveTwo
      ? await MaticDeploySolutionUtils.createPlatformAdapterAAVETwo(signer,
        deployCoreResults.controller,
        aaveTwoPool
      )
      : undefined;
    ...
    const platformAdapterDForce = deployDForce
      ? await MaticDeploySolutionUtils.createPlatformAdapterDForce(signer,
        deployCoreResults.controller,
        dForceComptroller,
        dForceCTokens
      )
    ...
    const platformAdapterHundredFinance = deployHundredFinance
      ? await MaticDeploySolutionUtils.createPlatformAdapterHundredFinance(signer,
        deployCoreResults.controller,
    ...
    const platformAdapterCompound3 = deployCompound3
      ? await MaticDeploySolutionUtils.createPlatformAdapterCompound3(
        signer,
        deployCoreResults.controller,
        compound3Comets,
        compound3Rewards,
    ...
    await MaticDeploySolutionUtils.writeResultsToFile(
      destPathTxt,
      deployCoreResults,
